...
Human-readable Chinese-language summaries of KNOWLEDGE documents.
...
Parent: `docs/knowledge/example-document.md`
Summary: `docs/knowledge/summary/example-document.md`
